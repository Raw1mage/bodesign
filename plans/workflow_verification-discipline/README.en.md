---
slug: workflow_verification-discipline
status: verified
lang: en
auto_generated: true
...
> Auto-generated index for the `workflow_verification-discipline` topic. Edit the source files; this README mirrors them. Do not edit this file directly.

## Status

**Verified** · 5 history entries · last advance 2026-06-12 (mode `promote` from implementing)
...
- 2026-06-12: `new` (initial) → proposed — initial spec created via plan-init.ts
...
<!-- AUTO-GENERATED by plan-builder MCP plan_sync · 2026-06-12T11:09:11Z · do not edit this file. -->
