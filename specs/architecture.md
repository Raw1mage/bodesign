...
- Connectivity reconstruction: the current first-pass fusion summarizes placement components against IPC pin/net evidence in the geometry API and Board View. Spatial fusion of Gerber pads/flashes, vias, drill hits, confidence scoring, and cross-probing remains pending.
